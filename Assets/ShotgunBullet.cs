...
public class ShotgunBullet : Projectile
{
    ...
    LayerMask standardBlockLayer; // Move to static class

    private new void Awake()
    {
        base.Awake();
        standardBlockLayer = LayerMask.NameToLayer("Standard Block");
    }
    ...
    private void FixedUpdate()
    {
        ...
        {
            if (collisions[i].collider.gameObject.layer == standardBlockLayer)
            {
